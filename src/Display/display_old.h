...
// Settings page subtab  0=Display 1=WiFi 2=RFID 3=Hue
static uint8_t       _settingsTab    = 0;
static uint8_t       _sleepMinutes   = 5;      // editable here

// Lamp page subtab  0=WLED  1=Hue
static uint8_t       _lampTab        = 0;

// Hue state
static uint8_t       _hueRoomSel     = 0;
static uint8_t       _hueSceneSel    = 0;
static uint8_t       _hueBrightness  = 65;
static bool          _hueOn          = false;
static char          _hueDisplayIp[24]  = "--";
static bool          _hueDisplayToken   = false;

// RFID subtab  0=Schrijven  1=Lezen
static uint8_t       _rfidSubTab     = 0;
static char          _rfidReadMerk[16]    = "--";
static char          _rfidReadType[8]     = "--";
static char          _rfidReadKleur[8]    = "------";
static char          _rfidReadGewicht[12] = "--";
static char          _rfidReadSerie[8]    = "------";
static bool          _rfidReadValid       = false;

// Write history (up to 5 entries, each is a full spoolData string)
static char          _rfidHistory[5][48]  = {};
static uint8_t       _rfidHistCount       = 0;
...
// Callbacks for Hue (implemented in main.cpp)
...
static const uint8_t _hueRoomCount = 4;
